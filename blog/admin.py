...
class BlogAdmin(admin.ModelAdmin):
    ...
    save_on_top = True
    fields = ('title', 'slug', 'cat', 'content', 'photo', 'get_html_photo_1', 'is_published', 'time_created')
    readonly_fields = ('get_html_photo_1', 'is_published', 'time_created')
    ...
    def get_html_photo_1(self, objects):
        if objects.photo:
            return mark_safe(f"<img src='{objects.photo.url}' width='150'>")
